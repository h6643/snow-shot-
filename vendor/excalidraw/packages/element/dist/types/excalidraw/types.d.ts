...
import type { IMAGE_MIME_TYPES, UserIdleState, throttleRAF, MIME_TYPES, ColorPaletteCustom, ColorTuple } from "@excalidraw/common";
import type { SuggestedBinding } from "@excalidraw/element";
import type { LinearElementEditor } from "@excalidraw/element";
import type { MaybeTransformHandleType } from "@excalidraw/element";
import type { PointerType, ExcalidrawLinearElement, NonDeletedExcalidrawElement, NonDeleted, TextAlign, ExcalidrawElement, GroupId, ExcalidrawBindableElement, Arrowhead, ChartType, FontFamilyValues, FileId, Theme, StrokeRoundness, ExcalidrawEmbeddableElement, ExcalidrawMagicFrameElement, ExcalidrawFrameLikeElement, ExcalidrawElementType, ExcalidrawIframeLikeElement, OrderedExcalidrawElement, ExcalidrawNonSelectionElement, PenMode } from "@excalidraw/element/types";
...
export type ToolType = "selection" | "lasso" | "rectangle" | "diamond" | "ellipse" | "arrow" | "line" | "freedraw" | "blur_freedraw" | "text" | "image" | "eraser" | "hand" | "frame" | "magicframe" | "embeddable" | "laser" | "blur" | "highlight" | "watermark";
...
export interface ExcalidrawPropsCustomOptions {
    ...
    onWheel?: (event: WheelEvent | React.WheelEvent<HTMLDivElement | HTMLCanvasElement>, zoomAction: () => void) => void;
    onContainerWheel?: (event: WheelEvent | React.WheelEvent<HTMLDivElement | HTMLCanvasElement>) => void;
    hideMainToolbar?: boolean;
    hideMenu?: boolean;
    hideFooter?: boolean;
    hideContextMenu?: boolean;
    onHistoryChange?: (history: History, type: "undo" | "redo" | "record" | "clear") => void;
    ...
    shouldRotateWithDiscreteAngle?: (event: MouseEvent | KeyboardEvent | React.PointerEvent<HTMLCanvasElement>) => boolean;
    canSelectType?: (type: ToolType | "custom", extraTools?: string[]) => boolean;
    shouldSnapping?: (event: KeyboardModifiersObject) => boolean;
    getReferenceSnapPoints?: (defaultFn: typeof getReferenceSnapPoints) => typeof getReferenceSnapPoints;
...
export declare const ExcalidrawPropsCustomOptionsContext: React.Context<ExcalidrawPropsCustomOptions | undefined>;
...
export declare const ExcalidrawHistoryContext: React.Context<ExcalidrawHistoryContextType | undefined>;
