...
export type ExcalidrawRectanguloidElement = ExcalidrawRectangleElement | ExcalidrawImageElement | ExcalidrawTextElement | ExcalidrawFreeDrawElement | ExcalidrawIframeLikeElement | ExcalidrawBlurElement | ExcalidrawHighlightElement | ExcalidrawWatermarkElement | ExcalidrawFrameLikeElement | ExcalidrawEmbeddableElement | ExcalidrawSelectionElement;
/**
 * ExcalidrawElement should be JSON serializable and (eventually) contain
 * no computed data. The list of all ExcalidrawElements should be shareable
 * between peers and contain no state local to the peer.
 */
export type ExcalidrawElement = ExcalidrawGenericElement | ExcalidrawTextElement | ExcalidrawLinearElement | ExcalidrawArrowElement | ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement | ExcalidrawImageElement | ExcalidrawFrameElement | ExcalidrawMagicFrameElement | ExcalidrawIframeElement | ExcalidrawEmbeddableElement | ExcalidrawBlurElement | ExcalidrawHighlightElement | ExcalidrawWatermarkElement;
...
export type ExcalidrawBlurFreeDrawElement = _ExcalidrawElementBase & Readonly<{
    type: "blur_freedraw";
    points: readonly LocalPoint[];
    lastCommittedPoint: LocalPoint | null;
    pressures: readonly number[];
