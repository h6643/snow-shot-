...
import type { ExcalidrawElement, ExcalidrawTextElement, NonDeletedExcalidrawElement, ExcalidrawFreeDrawElement, ExcalidrawImageElement, ExcalidrawFrameLikeElement, NonDeletedSceneElementsMap, ElementsMap, ExcalidrawBlurFreeDrawElement } from "./types";
...
export declare const pathsCache: WeakMap<ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement, Path2D>;
export declare function generateFreeDrawShape(element: ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement): Path2D;
export declare function getFreeDrawPath2D(element: ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement): Path2D | undefined;
export declare function getFreeDrawSvgPath(element: ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement): string;
...
export declare function getFreedrawOutlinePoints(element: ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement): [number, number][];
