...
export declare const getFontStrokeWidth: (fontSize: ExcalidrawTextElement["fontSize"], lineHeight: ExcalidrawTextElement["lineHeight"], textStrokeWidth: ExcalidrawTextElement["textStrokeWidth"]) => number;
