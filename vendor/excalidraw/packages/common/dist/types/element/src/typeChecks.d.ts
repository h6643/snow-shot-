...
export declare const isTextElement: (element: ExcalidrawElement | null | undefined) => element is ExcalidrawTextElement;
export declare const isHighlightElement: (element: ExcalidrawElement | null | undefined) => element is ExcalidrawHighlightElement;
...
export declare const isBlurElement: (element?: ExcalidrawElement | null) => element is ExcalidrawBlurElement;
...
export declare const isBlurElementType: (elementType: ElementOrToolType) => boolean;
export declare const isWatermarkElementType: (elementType: ElementOrToolType) => boolean;
