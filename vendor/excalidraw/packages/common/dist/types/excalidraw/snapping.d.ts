...
declare const getReferenceSnapPointsDefault: (elements: readonly NonDeletedExcalidrawElement[], selectedElements: ExcalidrawElement[], appState: AppState, elementsMap: ElementsMap) => GlobalPoint[];
export declare const setReferenceSnapPointsFunction: (fn: (defaultFn: typeof getReferenceSnapPointsDefault) => typeof getReferenceSnapPointsDefault) => void;
