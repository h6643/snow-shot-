...
export declare const TEXT_TRANSFORM_HANDLE_SPACING = 8;
export declare const SIDE_RESIZING_THRESHOLD: number;
export declare const TEXT_SIDE_RESIZING_THRESHOLD: number;
export declare const EPSILON = 0.00001;
export declare const DEFAULT_COLLISION_THRESHOLD: number;
export declare const TEXT_COLLISION_THRESHOLD: number;
...
export declare const TOOL_TYPE: {
    ...
    readonly blur_freedraw: "blur_freedraw";
    readonly text: "text";
