...
export declare const setShouldResizeFromCenter: (shouldResizeFromCenter: (event: MouseEvent | KeyboardEvent) => boolean) => void;
export declare const setShouldMaintainAspectRatio: (shouldMaintainAspectRatio: (event: MouseEvent | KeyboardEvent) => boolean) => void;
export declare const setShouldRotateWithDiscreteAngle: (shouldRotateWithDiscreteAngle: (event: MouseEvent | KeyboardEvent | React.PointerEvent<HTMLCanvasElement>) => boolean) => void;
export declare const setShouldSnapping: (shouldSnapping: (event: KeyboardModifiersObject) => boolean) => void;
...
export declare const shouldSnapping: (event: KeyboardModifiersObject) => boolean;
