...
import type { ElementsMap, ExcalidrawBindableElement, ExcalidrawBlurElement, ExcalidrawBlurFreeDrawElement, ExcalidrawDiamondElement, ExcalidrawElement, ExcalidrawEllipseElement, ExcalidrawEmbeddableElement, ExcalidrawFrameLikeElement, ExcalidrawFreeDrawElement, ExcalidrawHighlightElement, ExcalidrawIframeElement, ExcalidrawImageElement, ExcalidrawLinearElement, ExcalidrawRectangleElement, ExcalidrawSelectionElement, ExcalidrawTextElement, ExcalidrawWatermarkElement } from "@excalidraw/element/types";
...
type RectangularElement = ExcalidrawRectangleElement | ExcalidrawDiamondElement | ExcalidrawFrameLikeElement | ExcalidrawEmbeddableElement | ExcalidrawBlurElement | ExcalidrawWatermarkElement | ExcalidrawImageElement | ExcalidrawIframeElement | ExcalidrawTextElement | ExcalidrawSelectionElement | ExcalidrawHighlightElement;
...
export declare const getFreedrawShape: <Point extends GlobalPoint | LocalPoint>(element: ExcalidrawFreeDrawElement | ExcalidrawBlurFreeDrawElement, center: Point, isClosed?: boolean) => GeometricShape<Point>;
