...
export declare class ShapeCache {
     ...
     */
    static generateElementShape: <T extends ExcalidrawLinearElement | import("./types").ExcalidrawRectangleElement | import("./types").ExcalidrawBlurElement | import("./types").ExcalidrawHighlightElement | import("./types").ExcalidrawWatermarkElement | import("./types").ExcalidrawDiamondElement | import("./types").ExcalidrawEllipseElement | import("./types").ExcalidrawEmbeddableElement | import("./types").ExcalidrawIframeElement | import("./types").ExcalidrawImageElement | import("./types").ExcalidrawFrameElement | import("./types").ExcalidrawMagicFrameElement | import("./types").ExcalidrawTextElement | ExcalidrawFreeDrawElement | import("./types").ExcalidrawArrowElement | ExcalidrawBlurFreeDrawElement>(element: T, renderConfig: {
        isExporting: boolean;
